...
{
    public class WeeklyBundlesWithBundlePriceForMachineAggregator : IWeeklyBundlesWithBundleIDForMachineAggregator
    {
        ...
        public WeeklyBundlesWithBundlePriceForMachineAggregator(IFetchOneMachinesBundleService fetchOneMachinesBundleService,
        ...
        public async Task<OneOf<WeeklyMachineDataViewModel, APIError>> FetchWeeklyBundles(string machineID)
        {
            var oneOfBundle = await _fetchOneMachinesBundleService.FetchWeeklyBundle(machineID);
            ...
            return new WeeklyMachineDataViewModel()
            {
                AllFS = result.AllFS,
