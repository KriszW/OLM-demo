...
{
    public class ChangeExchangeRateModelAction
    {
        public ChangeExchangeRateModelAction(ExchangeRateViewModel newModelForEdit)
        {
            NewModelForEdit = newModelForEdit;
        }

        public ExchangeRateViewModel NewModelForEdit { get; set; }
    }
}
