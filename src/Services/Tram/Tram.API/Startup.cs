...
using OLM.Services.Tram.API.Extensions;
using OLM.Services.Tram.API.Filters;
using OLM.Shared.Extensions.APIErrorExceptionHandler;

namespace OLM.Services.Tram.API
{
    public class Startup
    {
        ...
        {
            services.AddDbContext<TramDbContext>(options =>
                options.UseSqlServer(Configuration.GetConnectionString("DefaultConnection")));

            services.AddHealthChecks().AddDbContextCheck<TramDbContext>();
