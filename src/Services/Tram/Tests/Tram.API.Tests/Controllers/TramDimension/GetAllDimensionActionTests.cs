...
{
    public class GetAllDimensionActionTests
    {
        [Fact]
        public async void ShouldReturnSuccess()
        {
            ...
            var actionResult = await controller.GetAllDimension();

            //Assert
            Assert.NotNull(actionResult);

            Assert.IsType<ActionResult<APIResponse<IEnumerable<string>>>>(actionResult);
            Assert.IsType<OkObjectResult>(actionResult.Result);
            var requestObject = Assert.IsAssignableFrom<ObjectResult>(actionResult.Result);
            var actual = Assert.IsAssignableFrom<APIResponse<IEnumerable<string>>>(requestObject.Value);
        ...
        public async void ShouldReturnNotFound()
        {
            ...
            var expectedMSG = $"Nincs dimenzió feltöltve az adatbázisba";
