...
using OLM.Services.RoutingTime.API.Extensions;
using OLM.Services.RoutingTime.API.Filters;
using OLM.Shared.Extensions.APIErrorExceptionHandler;

namespace OLM.Services.RoutingTime.API
{
    public class Startup
    {
        ...
        {
            services.AddDbContext<RoutingTimeDbContext>(options =>
                options.UseSqlServer(Configuration.GetConnectionString("DefaultConnection")));

            services.AddHealthChecks().AddDbContextCheck<RoutingTimeDbContext>();
