...
namespace OLM.Services.RoutingTime.Tests.API.Repositories.Pauses
{
    public class FetchBetweenMethodTests
    {
        ...
        {
            new object[] { DateTime.Now.Date.AddDays(-1), DateTime.Now.Date.AddDays(2), 10 },
            new object[] { DateTime.Now.Date, DateTime.Now.Date.AddHours(10), 1 },
            new object[] { DateTime.Now.Date, DateTime.Now.Date.AddHours(12), 2 },
            new object[] { DateTime.Now.Date, DateTime.Now.Date.AddHours(17), 3 },
            new object[] { DateTime.Now.Date, DateTime.Now.Date.AddDays(1).AddHours(12), 7 },
