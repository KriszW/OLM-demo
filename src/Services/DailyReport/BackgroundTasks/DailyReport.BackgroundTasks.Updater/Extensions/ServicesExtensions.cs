...
using OLM.Services.DailyReport.BackgroundTasks.Updater.BackgroundServices;
using OLM.Services.DailyReport.BackgroundTasks.Updater.Services.Factories.Abstractions;
using OLM.Services.DailyReport.BackgroundTasks.Updater.Services.Factories.Implementations;
using OLM.Services.DailyReport.BackgroundTasks.Updater.Services.Repositories.Abstractions;
using OLM.Services.DailyReport.BackgroundTasks.Updater.Services.Repositories.Implementations;
using OLM.Services.DailyReport.BackgroundTasks.Updater.Services.Services.Abstractions;
using OLM.Services.DailyReport.BackgroundTasks.Updater.Services.Services.Implementations;
...
namespace OLM.Services.DailyReport.BackgroundTasks.Updater.Extensions
{
    public static class ServicesExtensions
    {
        public static IServiceCollection AddCustomServices(this IServiceCollection services)
            ...
            .AddHostedService<DailyReportBackgroundService>();
