...
namespace OLM.Services.DailyReport.BackgroundTasks.Updater.BackgroundServices
{
    public class DailyReportBackgroundService : BackgroundService
    {
        private const int WaitingTimeInMSBetweenUpdates = 30000;

        private ILogger<DailyReportBackgroundService> _logger;
        private IHostApplicationLifetime _applicationLifetime;
        private IUpdaterService _uploaderService;

        public DailyReportBackgroundService(ILogger<DailyReportBackgroundService> logger, IHostApplicationLifetime applicationLifetime, IUpdaterService uploaderService)
        {
            _logger = logger;
