...
using OLM.Services.DailyReport.API.Filters;
using OLM.Shared.Extensions.APIErrorExceptionHandler;

namespace OLM.Services.DailyReport.API
{
    public class Startup
    {
        ...
        {
            services.AddDbContext<DailyReportDbContext>(options =>
            ...
            services.AddHealthChecks().AddDbContextCheck<DailyReportDbContext>();
