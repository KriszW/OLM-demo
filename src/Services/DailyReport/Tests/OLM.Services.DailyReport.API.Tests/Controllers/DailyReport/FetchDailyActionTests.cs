...
{
    public class FetchDailyActionTests
    {
        [Fact]
        public async void ShouldReturnSuccessForToday()
        {
            ...
            var actionResult = await controller.FetchDaily(tramData, date);
        ...
        public async void ShouldReturnNotFound()
        {
            ...
            var expectedMSG = $"A {date} időponthoz nem lehet lekérdezni a dimenzió selejt napi összesítését";
