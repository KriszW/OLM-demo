...
using OLM.Services.RoutingData.BackgroundTasks.Updater.BackgroundServices;
using OLM.Services.RoutingData.BackgroundTasks.Updater.Services.Factories.Abstractions;
using OLM.Services.RoutingData.BackgroundTasks.Updater.Services.Factories.Implementations;
using OLM.Services.RoutingData.BackgroundTasks.Updater.Services.Repositories.Abstractions;
using OLM.Services.RoutingData.BackgroundTasks.Updater.Services.Repositories.Implementations;
using OLM.Services.RoutingData.BackgroundTasks.Updater.Services.Services.Abstractions;
using OLM.Services.RoutingData.BackgroundTasks.Updater.Services.Services.Implementations;
...
namespace OLM.Services.RoutingData.BackgroundTasks.Updater.Extensions
{
    public static class ServicesExtensions
    {
        public static IServiceCollection AddCustomServices(this IServiceCollection services)
            ...
            .AddHostedService<RoutingDataUpdaterBackgroundService>();
