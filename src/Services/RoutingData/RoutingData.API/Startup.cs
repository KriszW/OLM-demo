...
using OLM.Services.RoutingData.API.Extensions;
using OLM.Services.RoutingData.API.Filters;
using OLM.Shared.Extensions.APIErrorExceptionHandler;

namespace OLM.Services.RoutingData.API
{
    public class Startup
    {
        ...
        {
            services.AddDbContext<RoutingDataDbContext>(options =>
                options.UseSqlServer(Configuration.GetConnectionString("DefaultConnection")));

            services.AddHealthChecks().AddDbContextCheck<RoutingDataDbContext>();
