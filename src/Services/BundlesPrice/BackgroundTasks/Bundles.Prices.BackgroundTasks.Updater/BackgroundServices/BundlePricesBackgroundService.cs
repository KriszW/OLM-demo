...
namespace OLM.Services.Bundles.Prices.BackgroundTasks.Updater.BackgroundServices
{
    public class BundlePricesBackgroundService : BackgroundService
    {
        private const int WaitingTimeInMSBetweenUpdates = 30000;

        private ILogger<BundlePricesBackgroundService> _logger;
        private IHostApplicationLifetime _applicationLifetime;
        private IUpdaterService _uploaderService;

        public BundlePricesBackgroundService(ILogger<BundlePricesBackgroundService> logger, IHostApplicationLifetime applicationLifetime, IUpdaterService uploaderService)
        {
            _logger = logger;
