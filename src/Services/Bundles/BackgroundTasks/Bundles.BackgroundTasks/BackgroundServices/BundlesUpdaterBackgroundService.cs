...
{
    public class BundlesUpdaterBackgroundService : BackgroundService
    {
        private const int WaitingTimeInMSBetweenUpdates = 30000;

        private ILogger<BundlesUpdaterBackgroundService> _logger;
        private IHostApplicationLifetime _applicationLifetime;
        private IUpdaterService _uploaderService;

        public BundlesUpdaterBackgroundService(ILogger<BundlesUpdaterBackgroundService> logger, IHostApplicationLifetime applicationLifetime, IUpdaterService uploaderService)
        {
            _logger = logger;
